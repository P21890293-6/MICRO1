...
* The original package name 'com.example.Usuarios1.2' is invalid and this project uses 'com.example.Usuarios12' instead.
...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/3.5.2/reference/web/spring-hateoas.html)
